...
export const THEME_CLUSTERS: SimilarityCluster[] = [
  ...
  {
    id: "revenge_vigilante",
    label: "месть и самосуд",
    kind: "theme",
    weight: 760,
    keywords: ["месть", "мстит", "отомстить", "revenge", "vengeance", "самосуд", "vigilante", "расправа", "наказывает преступников", "бывший агент", "бывший спецназовец", "бывший оперативник", "защитить семью", "убили жену", "убили дочь", "личная война"],
  },
  {
    id: "assassin_hitman_action",
    label: "киллеры и профессиональные убийцы",
    kind: "theme",
    weight: 720,
    keywords: ["киллер", "наемный убийца", "hitman", "assassin", "убийца", "профессиональный убийца", "контракт", "охота на героя", "бывший киллер", "элитный агент", "секретная организация"],
  },
  {
    id: "criminal_underworld_action",
    label: "криминальный экшен",
    kind: "theme",
    weight: 650,
    keywords: ["криминальная организация", "преступная организация", "мафия", "картель", "gang", "criminal underworld", "банда", "коррупция", "преступный мир", "отмывание денег", "наркокартель"],
  },
  {
    id: "heist",
