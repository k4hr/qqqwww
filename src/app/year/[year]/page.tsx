...
export default async function YearPage({ params, searchParams }: Props) {
  ...
  if (count < 5) notFound();
  const contentType = type === "SERIES" ? ContentType.SERIES : type === "CARTOON" ? ContentType.CARTOON : type === "ANIME" ? ContentType.ANIME : type === "MOVIE" ? ContentType.MOVIE : undefined;
