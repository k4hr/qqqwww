...
import { similarPageJsonLd } from "@/lib/seo/schema";
...
export default async function SimilarPage({ params }: Props) {
  ...
  const intro = similarSeoIntro(movie).slice(0, 1);
  const countries = extractCountries(movie.country);

  return <div className="container py-6">
    <JsonLd data={similarPageJsonLd(movie, similar)} />
