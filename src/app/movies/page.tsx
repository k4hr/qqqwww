...
export default async function Page({ searchParams }: Props) {
  ...
  return <ListPage title={yearLabel ? `Фильмы ${yearLabel}` : "Фильмы"} type={ContentType.MOVIE} sort={sort} yearFilter={year} genreSlug={genre} country={country} showCountryFilter page={Number(page) || 1} />;
}
